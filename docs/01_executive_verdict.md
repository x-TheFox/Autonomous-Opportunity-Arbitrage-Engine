...
flowchart TD
    subgraph Web2_Broken ["BROKEN WEB2 PARADIGM (STRUCTURAL COLLAPSE)"]
        ...
        W6 -->|Unique Finding| W8[Submit Markdown Report]
        W8 -->|Subjective Triage Layer| W9{Human Triager Evaluation}
    ...
    subgraph Web3_Winning ["WINNING AOAE PARADIGM (MACHINE-VERIFIABLE ARBITRAGE)"]
        M1[Target Ingestion: Immunefi TVL & Verified Code] --> M2[Local State Mirroring: Anvil / Hardhat Fork]
        ...
        M8 -->|Failed Replay| M6
        M8 -->|100% Deterministic Reproducibility| M9[Package Automated Executable PoC]
    ...
    style Web3_Winning fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px;
    style W13 fill:#ffcdd2,stroke:#b71c1c,stroke-width:1px;
    style M13 fill:#c8e6c9,stroke:#1b5e20,stroke-width:1px;
```
